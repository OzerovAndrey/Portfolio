...
2. **Motion бренду** (+2 ключі до 55, однакові для всіх брендів):
   ...
   Після sync — оновити `tools/upstream.json` (brandKeys = 57) і `brand/site.json` портфоліо. (Тимчасовий `tokens/site/demo-motion.json` портфоліо прибрано разом зі сценою в hero.)
...
Після мержу в демо: `node tools/sync-demo-tokens.mjs` у портфоліо → видалити `tokens/site/map.json`
